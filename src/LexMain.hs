...
alex_accept = listArray (0::Int,5) [AlexAccNone,AlexAccNone,AlexAccSkip,AlexAcc 2,AlexAcc 1,AlexAcc 0]

alex_actions = array (0::Int,3) [(2,alex_action_1),(1,alex_action_2),(0,alex_action_3)]
...
{-# LINE 10 "<command-line>" #-}
{-# LINE 1 "C:\\Users\\randy\\AppData\\Local\\Temp\\ghc5588_0\\ghc_2.h" #-}
